...
#ifndef DEJAVU_FEATURE_MAP_H
#define DEJAVU_FEATURE_MAP_H
...
class FeatureMap {
  ...
  clarus::List<FeaturePoint> features_;
...
public:
  ...
  */
  ...
  evaluated image.
  */
  cv::Mat operator () (const clarus::List<cv::Mat> &images, int padding, int i0 = 0, int n = 0) const;
